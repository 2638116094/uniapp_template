...
// 		} else {
// 			this.Notification = plus.android.importClass("android.suppor.v4.app.NoticationCompat");
// 		}
		
// 		if(this.Notification) {
// 			const Build = plus.android.importClass("android.os.Build");
// 			if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
// 				// android8.0 及以上需要设置通知渠道才能显示通知
// 				// 创建通知渠道
// 				const name = "渠道名称1";
// 				const description = "渠道描述1";
// 				const channelId = "channelId1"; // 渠道id
// 				const importance = NotificationManager.IMPORTANCE_LOW; // 重要级别
// 				const NotificationChannel = plus.android.importClass("android.app.NotificationChannel");
// 				const mChannel = new NotificationChannel(channelId, name, importance);
// 				mChannel.setDescription(description); // 渠道描述
// 				mChannel.setDescription("渠道描述1");
// 				mChannel.enableLights(false); //是否显示通知指示灯
// 				mChannel.enableVibration(false); // 是否震动
// 				nm.createNotificationChannel(mChannel); // 创建通知渠道
// 				this.notifyManager = nm;
// 				this.mNotificationBuild = new this.Notification.Build(main,channelId);
// 			} else {
// 				this.notifyManager = nm;
// 				this.mNotificationBuild = new this.Notification.Build(main);
// 			}
// 		}
// 	};
...
// 			if(intentList) {
// 				const pendingIntent = this.create
// 			}
// 		}
// 	}
// }
...
export default class NotificationUtil {
  ...
  createNotification = (config) => {
    let { title, content, tickerTips, notifyId } = config;
	console.log('config',!this.mNotificationBuild || !this.notifyManager);
    if (!this.mNotificationBuild || !this.notifyManager) {
      return;
    }
    notifyId = typeof notifyId == "number" ? notifyId : this.defaultNotifyId;
